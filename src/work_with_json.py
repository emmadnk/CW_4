...
class WorkWithJSON(AbstractJSON):
    ...
    def maintaining_vacancies(vacancies):
        ...
        """
        with open("../data/vacancies.json", "w", encoding="utf8") as file:
    ...
    def add_vacancy(self, name):
        ...
        with open("../data/my_vacancies.json", "r", encoding="utf8") as file:
        ...
        with open("../data/my_vacancies.json", "w", encoding="utf8") as file:
